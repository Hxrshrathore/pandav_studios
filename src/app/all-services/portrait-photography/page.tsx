...
import { Sun, Moon, ArrowUp, Heart, Clock, Image as ImageIcon, DollarSign } from "lucide-react"
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.capturestudio.com/all-services/wedding-photography" />
        ...
        <meta property="og:url" content="https://www.capturestudio.com/all-services/wedding-photography" />
      ...
      <div className="flex flex-col min-h-screen bg-background text-foreground">
        ...
        <main className="flex-1">
          ...
          <section id="portrait-packages" className="w-full py-12 md:py-24 lg:py-32">
  <div className="container px-4 md:px-6">
    <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8">Portrait Photography Packages</h2>
    <div className="grid gap-6 lg:grid-cols-2">
      {[
        ...
        },
        {
          ...
          custom: true, // Flag to render a contact button
        },
      ].map((pkg, index) => (
        <Card key={index} className="flex flex-col justify-between">
          ...
          <CardFooter>
            {pkg.custom ? (
              ...
              <Button className="w-full"><a href='/contact'>Choose {pkg.name}</a></Button>
            )}
          </CardFooter>
        </Card>
      ))}
