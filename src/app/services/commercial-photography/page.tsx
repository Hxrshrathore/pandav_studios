...
import { Camera, Sun, Moon, ArrowUp, Building, ShoppingBag, Users, DollarSign } from "lucide-react"
...
const faqs = [
  {
    question: "What types of commercial photography do you offer?",
    answer: "We offer a wide range of commercial photography services, including product photography, corporate headshots, event coverage, architectural photography, food photography, and lifestyle shots for brands. Our team can tailor our services to meet your specific business needs."
  },
  {
    question: "How long does a typical commercial photo shoot take?",
    answer: "The duration of a commercial photo shoot can vary greatly depending on the scope of the project. A basic product shoot might take just a few hours, while a comprehensive brand lifestyle shoot could span several days. During our initial consultation, we'll discuss your needs and provide an estimated timeline."
  },
  {
  ...
  },
  {
    ...
    answer: "Our commercial use license allows you to use the photos for your business marketing materials, website, social media, and advertising campaigns. The specific terms may vary based on the package and intended use. We'll provide a detailed licensing agreement that outlines all permitted uses."
  },
  {
...
export default function CommercialPhotographyPage() {
  ...
  return (
    <>
      <Head>
        <title>Commercial Photography Services | Capture Studio</title>
        <meta name="description" content="Elevate your brand with our professional commercial photography services. From product shots to corporate events, we deliver high-quality images that showcase your business." />
        <meta name="keywords" content="commercial photography, product photography, corporate headshots, brand photography, business photography" />
        <link rel="canonical" href="https://www.capturestudio.com/services/commercial-photography" />
        <meta property="og:title" content="Commercial Photography Services | Capture Studio" />
        <meta property="og:description" content="Professional commercial photography services to elevate your brand. From product shots to corporate events, we deliver high-quality images for your business." />
        <meta property="og:image" content="https://www.capturestudio.com/images/commercial-photography-og.jpg" />
        <meta property="og:url" content="https://www.capturestudio.com/services/commercial-photography" />
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
            <div className="container px-4 md:px-6 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 mb-8">
                Let&apos;s create stunning visuals that showcase your products and services in the best light. Contact us today to discuss your commercial photography needs.
              </p>
