...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <Script
        async
        src="https://www.googletagmanager.com/gtag/js?id=AW-11455979580"
                ...
                <div className="space-y-4">
                  ...
                  <Card>
                    <CardContent className="flex items-center p-4">
                      ...
                      <p>
                        <a href="tel:+919334439313">+91 93344 39313</a>
                      </p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="flex items-center p-4">
                      ...
                      <p>
                        <a href="mailto:info@pandav.studio">info@pandav.studio</a>
                      </p>
                    </CardContent>
                  </Card>
                </div>
          ...
          <section className="py-16 bg-muted">
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <Link
                  href="https://www.facebook.com/profile.php?id=61550744053524"
                  className="text-foreground hover:text-primary"
                >
                  <Facebook className="h-8 w-8" />
                </Link>
                <Link
                  href="https://www.youtube.com/@studiopandavvision"
                  className="text-foreground hover:text-primary"
                >
            ...
            <div className="grid gap-8 md:grid-cols-4">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/all-services" className="hover:underline">
                      Services
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/all-services/wedding-photography" className="hover:underline">
                      Wedding Photography
                    </Link>
                  </li>
                  <li>
                    <Link href="/all-services/portrait-photography" className="hover:underline">
                      Portrait Photography
                    </Link>
                  </li>
                  <li>
                    <Link href="/all-services/Engagement-photography" className="hover:underline">
